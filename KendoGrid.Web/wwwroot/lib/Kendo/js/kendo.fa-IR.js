...
function noRecorGrid(e) {
    var grid = e.sender;
    if (grid.dataSource.total() === 0) {
        var colCount = grid.columns.length;
        $(e.sender.wrapper)
            .find('tbody')
            .append('<tr class="kendo-data-row" style="background-color:#f1ecc6;"><td colspan="' + colCount + '" class="no-data">رکوردی یافت نشد</td></tr>');
    }
}

kendo.ui.noRecorGrid = noRecorGrid;